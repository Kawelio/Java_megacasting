...
public class Information {
    ...
    private String password_information;
    private int level_information;
    ...
    public String getPassword_information() {
        return password_information;
    }

    public void setPassword_information(String password_information) {
        this.password_information = password_information;
    }

    public int getLevel_information() {
        return level_information;
    }

    public void setLevel_information(int level_information) {
        this.level_information = level_information;
    }
